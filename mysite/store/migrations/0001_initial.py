    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_comment', to='store.post')),
            ],
        ),
        migrations.CreateModel(
            name='Saved',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_saveItem', to='store.post')),
                ('saved', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='saved_saveItem', to='store.saved')),
            ],
        ),
        migrations.CreateModel(
            name='Story',
            fields=[
                ...
                ('video', models.FileField(blank=True, null=True, upload_to='story_vide')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like', models.BooleanField(default=False)),
                ('created_at', models.DateField(auto_now=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_like', to='store.post')),
